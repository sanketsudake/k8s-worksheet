...
- **Symptom:** Ready, but clients still get errors briefly. **Cause:** EndpointSlice/kube-proxy propagation lag across nodes. **Where to look:** slice contents vs kube-proxy sync metrics (Flow 23).
