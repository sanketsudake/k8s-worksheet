...
- **Admission:** webhooks, CEL ValidatingAdmissionPolicy — in-process, GA v1.30.
- **New types:** CRDs plus your controllers, or full aggregated API servers like metrics-server.
- **KMS:** secrets encryption at rest.

**Scheduler:** framework plugins (Chapter 3).

**Cloud controller manager:** isolates provider code (nodes, load balancers, routes).

**Node:**

- **CRI:** kubelet speaks to the runtime.
- **CNI:** runtime execs the plugins.
- **CSI:** kubelet speaks for volumes.
- **DRA/device plugins:** kubelet speaks for hardware.
