...
- **Symptom:** scheduler and KCM exited and sit leaderless. **Cause:** leader-election writes failing — they fail-stop and wait for the lease, by design. **Where to look:** their logs show lease renewal errors; fix etcd, not the controllers.
